...
<!--					<h6 class="text-muted text-center"><i class="fa fa-user-secret"></i> Admin.  <i class="fa fa-umbrella"></i> General.  <i class="fa fa-calendar"></i> 14 Jan 2017.</h6>-->
					<img src="<?php echo base_url(); ?>uploads/products/<?=  $data[0]->image; ?>" class="img-responsive" alt="">
...
<!--				</div>-->
				<div class="recent-post single-sidebar">
					...
					<div class="recent-single">
						<a href="<?php echo base_url(); ?>home/product_details/<?=$products[$i]->id;?>"><img src="<?php echo base_url(); ?>uploads/products/<?=  $products[$i]->image; ?>" class="img-responsive" alt="image">
						</a>
						<a href="<?php echo base_url(); ?>home/product_details/<?=$products[$i]->id;?>"><h4><?=  $products[$i]->title; ?></h4></a>
