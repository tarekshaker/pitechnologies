		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="single-blog-details wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s" data-wow-offset="0">
					<img src="<?php echo base_url(); ?>uploads/news/<?=  $data[0]->image; ?>" class="img-responsive" alt="">
...
<!--				</div>-->
				<div class="recent-post single-sidebar">
					...
					<div class="recent-single">
						<a href="<?php echo base_url(); ?>home/news_details/<?=$news[$i]->id;?>"><img src="<?php echo base_url(); ?>uploads/news/<?=  $news[$i]->image; ?>" class="img-responsive" alt="image">
						</a>
						<a href="<?php echo base_url(); ?>home/news_details/<?=$news[$i]->id;?>"><h4><?=  $news[$i]->title; ?></h4></a>
