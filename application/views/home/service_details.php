		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="single-blog-details wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s" data-wow-offset="0">
					<img src="<?php echo base_url(); ?>uploads/services/<?=  $data[0]->image; ?>" class="img-responsive" alt="">
...
<!--				</div>-->
				<div class="recent-post single-sidebar">
					...
					<div class="recent-single">
						<a href="<?php echo base_url(); ?>home/service_details/<?=$services[$i]->id;?>"><img src="<?php echo base_url(); ?>uploads/services/<?=  $services[$i]->image; ?>" class="img-responsive" alt="image">
						</a>
						<a href="<?php echo base_url(); ?>home/service_details/<?=$services[$i]->id;?>"><h4><?=  $services[$i]->title; ?></h4></a>
